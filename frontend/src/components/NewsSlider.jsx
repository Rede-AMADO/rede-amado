...
function NewsSlider() {
  // 1. Transformamos o array de notícias em um state para futuras modificações dinâmicas,
  //    mas ainda inicializamos com as 5 notícias de exemplo.
  ...
  // 2. Estado que controla qual índice está sendo exibido atualmente
  const [currentIndex, setCurrentIndex] = useState(0);

  // 3. Intervalo automático: a cada 5 segundos, avança para o próximo slide
  useEffect(() => {
  ...
  // 4. Selecionamos a notícia atual com base no índice
  const currentNews = newsItems[currentIndex];

  // 5. Função para clicar diretamente em uma bolinha e definir o slide
  ...
  return (
    <section
      ...
      /*
        • py-12: padding vertical alto para espaçar bem do Header e das outras seções.
        • bg-white bg-opacity-20: fundo branco quase transparente para deixar o panorama visível.
      */
    >
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center">
        {/*
          • flex flex-col md:flex-row: empilha em telas pequenas, coloca lado a lado em md+.
          • items-center: centraliza conteúdo verticalmente.
        */}

        {/* BOX DE TEXTO À ESQUERDA */}
      ...
      {/* BOLINHAS DE NAVEGAÇÃO ABAIXO DO SLIDER */}
